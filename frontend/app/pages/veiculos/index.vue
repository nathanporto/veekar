          ...
          <tr v-for="v in store.vehicles" :key="v.id" class="hover:bg-gray-50 transition-colors">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <NuxtLink :to="`/veiculos/${v.id}`" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                  Ver
                </NuxtLink>
                <span class="text-gray-300">|</span>
                <NuxtLink :to="`/veiculos/${v.id}/editar`" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                  Editar
                </NuxtLink>
                <span class="text-gray-300">|</span>
                <button
